...
export declare function generatePreamble(config: d.Config, content?: string): string;
...
export declare function catchError(diagnostics: d.Diagnostic[], err: Error): d.Diagnostic;
