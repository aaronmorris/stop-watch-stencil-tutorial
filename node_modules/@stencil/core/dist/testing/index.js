...
class InMemoryFileSystem {
    ...
    commitWriteFiles(filesToWrite) {
        return Promise.all(filesToWrite.map((filePath) => __awaiter$1(this, void 0, void 0, function* () {
            if (typeof filePath !== 'string') {
    ...
    commitDeleteFiles(filesToDelete) {
        return Promise.all(filesToDelete.map((filePath) => __awaiter$1(this, void 0, void 0, function* () {
            if (typeof filePath !== 'string') {
 ...
 */
function transpileModuleForTesting(config, compilerOptions, path$$1, input) {
    const moduleFiles = {};
    const diagnostics = [];
...
function versionElementAssets(config, compilerCtx, outputTarget, windowLocationHref, doc) {
    return __awaiter$7(this, void 0, void 0, function* () {
        ...
        yield Promise.all(ELEMENT_TYPES.map((elmType) => __awaiter$7(this, void 0, void 0, function* () {
    ...
    return __awaiter$8(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (Array.isArray(manifest.icons)) {
                yield Promise.all(manifest.icons.map((manifestIcon) => __awaiter$8(this, void 0, void 0, function* () {
...
function hydrateHtml(config, compilerCtx, outputTarget, cmpRegistry, opts) {
    return new Promise(resolve => {
        ...
        plt.onAppLoad = (rootElm, styles, failureDiagnostic) => __awaiter$17(this, void 0, void 0, function* () {
