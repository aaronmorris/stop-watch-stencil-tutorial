...
class StyleProperties {
    ...
    hasNonNestedSemicolon(property) {
    ...
    sanitizeSemicolons(property, startIndex) {
        const openingParen = property.indexOf('(', startIndex);
        if (openingParen === -1) {
            return property;
        }
        const closingParens = findMatchingParen(property, openingParen);
        ...
        if (this.supportsCssVars) {
            ...
            this.win.requestAnimationFrame(() => {
                ...
                for (var i = 0; i < linkElms.length; i++) {
                    promises.push(loadLinkStyles(this.doc, this, linkElms[i]));
                }
